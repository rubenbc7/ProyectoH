...
public class CarControllerPlayer :MonoBehaviour
{
	...
	DriveTypePlayer DriveTypePlayer { get { return CarConfig.DriveTypePlayer; } }
	...
	private void Awake ()
	{
		...
		//Set drive wheel.
		switch (DriveTypePlayer)
		{
			case DriveTypePlayer.AWD:
			FirstDriveWheel = 0;
			LastDriveWheel = 3;
			break;
			case DriveTypePlayer.FWD:
			FirstDriveWheel = 0;
			LastDriveWheel = 1;
			break;
			case DriveTypePlayer.RWD:
			FirstDriveWheel = 2;
			LastDriveWheel = 3;
			break;
		}
...
public class CarConfig
{
	...
	public DriveTypePlayer DriveTypePlayer = DriveTypePlayer.RWD;				//Drive type AWD, FWD, RWD. With the current parameters of the car only RWD works well. TODO Add rally and offroad regime.
